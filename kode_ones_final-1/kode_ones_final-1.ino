...
//Constants
const String API_KEY = "RKPSBJZZCTSJ6A9X";
...
void updateThingSpeak(){
  ...
  HTTPClient http;
  sprintf(thingspeakUpdateQuery, "http://api.thingspeak.com/update?api_key=%s&field1=%d&field2=%s&field3=%s&field5=%s&field6=%s", API_KEY, percent, temperatureChar, heartRateChar, latitude, longitude);
